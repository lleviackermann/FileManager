...
public:
     ...
     */
    virtual std::vector<std::string> listContents(const std::string &folderName) = 0;
     ...
     */
    virtual std::vector<std::string> listDirectoryStructure() = 0;
     ...
     */
    virtual std::string searchFileExactMatch(const std::string &folderName, const std::string &fileName) = 0;
    ...
    searchFileLikeMatch(const std::string &folderName, const std::string &pattern) = 0;
};
