...
public:
    ...
    std::vector<std::string> listContents(const std::string &folderName) override;

    std::vector<std::string> listDirectoryStructure() override;

    std::string searchFileExactMatch(const std::string &folderName, const std::string &fileName) override;

    std::vector<std::string>
    searchFileLikeMatch(const std::string &folderName, const std::string &pattern) override;
};
